...
is. The stranded value is not baseline-subtracted: value on pairs that were outside the largest
component before any removal is included, so each figure is an upper bound. It also reports a reachability-style statistic that excludes incident value entirely:
